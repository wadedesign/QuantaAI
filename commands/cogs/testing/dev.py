...
class Developer(commands.Cog):
    ...
    @dev.subcommand(name="developer", description="Get info about the bot's developer") 

    async def developer(self, interaction : nextcord.Interaction):

        embed = nextcord.Embed(color=nextcord.Color.blurple())
        embed.set_author(name="Bot Developer", icon_url=interaction.bot.user.avatar.url)
        embed.add_field(name="Name", value="Wade5")
        embed.add_field(name="GitHub", value="[Link to GitHub](https://github.com/Tomato6966/Discord-Js-Handler-Template)")
        embed.add_field(name="Support Server", value="[Link to Support Server](https://discord.gg/milrato)")
        embed.set_footer(text="Made with ❤️ using Nextcord")
