...
from utils.WF2.WadderConfigs import MAIN_COLOR, RED_COLOR
...
async def replace_things_in_string_fancy_lemao(bot, array, string_):
    ...
    if inviter_id == 'Unknown':
        ...
        inviter_avatar = 'https://cdn.nextcordapp.com/embed/avatars/1.png'
        ...
        inviter_avatar = 'https://cdn.nextcordapp.com/embed/avatars/1.png' if inviter__ is None else inviter__.display_avatar.url
    ...
    nice = {
        ...
        "{guild_icon}": guild.icon.url if guild.icon is not None else 'https://cdn.nextcordapp.com/embed/avatars/1.png',
